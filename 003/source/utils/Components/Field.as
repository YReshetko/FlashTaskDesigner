package source.utils.Components {
	...
	public class Field extends Sprite{
		...
		public static var FIELD_FOCUS_OUT:String = 'onFieldFocusOut';
		...
		public function Field() {
			...
			field.addEventListener(FocusEvent.FOCUS_OUT, FOCUS_OUT);
		}
		...
		private function FOCUS_OUT(event:FocusEvent):void{
			super.dispatchEvent(new Event(FIELD_FOCUS_OUT));
		}
