package source.Task.TaskSettings.SamplePanel.PanelChoise {
	...
	public class SampleCheck extends Sprite{
		...
		public function setSampleSize(W:int, H:int):void{
			Height = H;
			Width = W;
		...
		public function setData(inData:*):void{
			Data = inData;
		}
		...
		private function THIS_MOUSE_OVER(e:MouseEvent):void{
			currentBackgraund = CheckBoxSettings.selectBackgraund;
			CheckBoxSettings.drawBackgraund(super, Width, Height, currentBackgraund);
		}
		private function THIS_MOUSE_OUT(e:MouseEvent):void{
			currentBackgraund = CheckBoxSettings.defaultBackgraund;
			CheckBoxSettings.drawBackgraund(super, Width, Height, currentBackgraund);
		}
	}
