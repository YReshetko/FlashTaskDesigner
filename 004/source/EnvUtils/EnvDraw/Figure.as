package source.EnvUtils.EnvDraw {
	...
	public class Figure {
		...
		public static function insertDiffCurve(inSprite:Sprite, pointArr:Array, lineAlpha:Number = 1, lineThick:int = 1, lineColor:uint = 0x000000, fillAlpha:Number = 1, fillColor:uint = 0xD6D6D6):void{
			var i:int;
			var leng:int = pointArr.length;
